...
public class FTPUtil {
    ...
    public static boolean moveFile(String remotePath, String fileName, String localPath) {
        FTPUtil ftpUtil = new FTPUtil(ftpIp, ftpPort, ftpUser, ftpPass);
        return ftpUtil.retrieveFile(remotePath, fileName, localPath);
    }

    private boolean retrieveFile(String remotePath, String fileName, String localPath) {
        // 初始表示下载失败
